...
class OffPolicyTrainer:
    ...
    def add_sample_scalar(self, tag: str, value: float, step: int):
        wandb.log({"sample/sample_step": step, f"sample/{tag}": value})
        self.logger.add_scalar(f"sample/{tag}", value, step)
        self.logger.flush()

    def add_update_scalar(self, tag: str, value: float, step: int):
        wandb.log({"update/update_step": step, f"update/{tag}": value})
        self.logger.add_scalar(f"update/{tag}", value, step)
        self.logger.flush()
